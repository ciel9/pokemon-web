...
class MyPokemon extends Component {
  ...
  handleReleaseShow(e) {
    ...
    this.setState({
      ...
      imgRelease: e.target.attributes["data-image"].value,
      idRelease: e.target.attributes["data-id"].value,
    });
  }

  releaseMyPokemon() {
    this.props.dispatch(
      PokemonAction.releaseMyPokemon(parseInt(this.state.idRelease), () => {
  ...
  render() {
    return (
      <div>
        <h3 className="title">{this.props.MyPokemonList.length} Pokemon's</h3>
          ...
          <tbody>
            {this.props.MyPokemonList.map((data) => {
              return (
                ...
                >
                  <td className="middle" width="20">
                    <a className="td_id">#{data.id}</a>
                  </td>
                  <td className="middle" width="40">
                    <img height="45" src={data.image} alt="" />
                  </td>
                  <td className="middle">
                  ...
                  <td width="90">
                    <button
                      className="btn-release-list btn btn-danger"
        ...
        <Modal show={this.state.modalReleaseShow} animation={false}>
          ...
          <Modal.Body>
            <img
              ...
              src={this.state.imgRelease}
              alt=""
              width="30%"
            />
            <p>Are you sure want to delete your pokemon ?</p>
          </Modal.Body>
          <Modal.Footer>
