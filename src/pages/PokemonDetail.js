...
import pokecatch from '../assets/images/pokemon-catch.gif';
        ...
        <div>
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <div
                className="col-md-3 col-sm-3 img-thumnail"
                onClick={() => {
                  this.changeImageThumbnail(
                    this.props.PokemonDetail.sprites.front_default
                  );
                }}
              >
                <img
                  width="100%"
                  src={
                    this.props.PokemonDetail.sprites
                      ? this.props.PokemonDetail.sprites.front_default
                      : placeholder
                  }
                />
              ...
              <div
                ...
                onClick={() => {
                  this.changeImageThumbnail(
                    this.props.PokemonDetail.sprites.back_shiny
                  );
                }}
              >
                <img
              ...
              <div
                ...
                onClick={() => {
                  this.changeImageThumbnail(
                    this.props.PokemonDetail.sprites.back_default
                  );
                }}
              >
                <img
              ...
              <div className="col-md-3  col-sm-3 img-thumnail">
                <img
                  ...
                  onClick={() => {
                    this.changeImageThumbnail(
                      this.props.PokemonDetail.sprites.front_shiny
                    );
                  }}
                  src={
                    this.props.PokemonDetail.sprites
              ...
              >
                <button
                  style={{ display: this.state.isOwned ? "none" : "block" }}
                  className="btn-detail btn-catch btn btn-info"
                  onClick={this.handleShow}
                >
                  CATCH THIS
                </button>
                <button
                  style={{ display: this.state.isOwned ? "block" : "none" }}
                  className="btn-detail btn-owned btn btn-default"
                  disabled={true}
                >
                  OWNED
                </button>
                <button
                  style={{ display: this.state.isOwned ? "block" : "none" }}
                  className="btn-detail btn-release btn btn-danger"
                  onClick={this.handleReleaseShow}
                >
                  DELETE
                </button>
              </div>
            ...
            <div className="col-md-8">
              <div
                ...
                style={{
                  display: this.state.myData.nickname ? "block" : "none",
                }}
              >
                <span className="nick-label">Nickname</span>
                <h3 className="nickname">{this.state.myData.nickname}</h3>
              </div>
              <div className="row">
                <div class="col-md-6">
                  ...
                  <table className="table table-striped table-pokemondetail">
                    <tbody>
                      <tr>
                        <th width="90">Name</th>
                        <td>{this.props.PokemonDetail.name}</td>
                      </tr>
                      <tr>
                        <th width="90">Type</th>
                        <td>
                          {this.props.PokemonDetail.types.map((data) => {
                            return (
                              <span
                                key={data.type.name}
                                className="label label-info label-types"
                              >
                                {data.type.name}
                              </span>
                            );
                      ...
                      <tr>
                        ...
                        <td>{this.props.PokemonDetail.weight}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th width="90">Base Exp</th>
                        <td>{this.props.PokemonDetail.base_experience}</td>
                      </tr>
                    </tbody>
                  </table>
                  <p className="title">&copy; 2022 - Yohana Cindy Elsanjaya</p>
                </div>
                <div class="col-md-6 ">
                  <div className="subtitle">
                    <label>Moves</label>
          ...
          >
            <Modal.Body>
              ...
              <img
                className="img-catch"
                src={this.props.PokemonDetail.sprites.front_default}
                style={{
                  display:
                    !this.state.isCatch && this.state.pokeAnim == pokecatchstop
                      ? "block"
                      : "none",
                }}
                width="30%"
              ...
              <div className="span-catch-wrapper">
                <span
                  ...
                  style={{
                    display:
                      this.state.pokeAnim == pokecatchstop ? "block" : "none",
                  }}
                >
                  {this.state.isCatch ? "Succes !" : "Fail !"}
                </span>
              </div>
            </Modal.Body>
          </Modal>
          ...
          <Modal
            backdrop={"static"}
            keyboard={false}
            show={this.state.modalNameShow}
            animation={false}
          >
            <Modal.Body>
              <img
                className="img-catch-preview"
                src={this.props.PokemonDetail.sprites.front_default}
                width="30%"
              />
              <div className="form-group form-nickname">
                ...
                <span
                  ...
                  style={{
                    display: this.state.nickname === "" ? "block" : "none",
                  }}
                >
              ...
              <div className="form-group form-nickname">
                <button
                  disabled={this.state.nickname === "" ? true : false}
                  onClick={this.saveMyPokemon}
                  className="btn btn-success btn-nickname"
                >
                  OK
                </button>
              </div>
          ...
          <Modal show={this.state.modalReleaseShow} animation={false}>
            ...
            <Modal.Body>
              <img
                ...
                width="30%"
              />
              <p>Are you sure to delete your pokemon ?</p>
            </Modal.Body>
            <Modal.Footer>
              <Button variant="secondary" onClick={this.handleReleaseHide}>
                Cancel
              </Button>
              <Button variant="danger" onClick={this.releaseMyPokemon}>
                Delete
              </Button>
            </Modal.Footer>
          </Modal>
