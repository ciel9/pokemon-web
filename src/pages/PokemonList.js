...
class PokemonList extends Component {
  ...
  render() {
    return (
      <div>
        <h3 className="title">
          {this.props.PokemonList.results.length} of{" "}
          {this.props.PokemonList.count} Pokemons
        </h3>
        ...
        <div
          ...
          style={{
            display:
              this.props.PokemonList.results.length <
              this.props.PokemonList.count
                ? "block"
                : "none",
          }}
          onClick={() => {
